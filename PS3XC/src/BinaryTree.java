...
public class BinaryTree<E> {
    ...
    int order; // added order to BinaryTree to track order of creation.
    ...
    public BinaryTree(E data) {
        this.data = data; this.left = null; this.right = null; this.order = globalOrder++;
    }
    ...
    public BinaryTree(E data, BinaryTree<E> left, BinaryTree<E> right) {
        this.data = data; this.left = left; this.right = right; this.order = globalOrder++;
    }
