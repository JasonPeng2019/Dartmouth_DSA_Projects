...
public class Ellipse implements Shape {
	...
	@Override
	/**
	 * determines if an input point is within the ellipse
	 */
	...
	@Override
	/**
	 * move the ellipse by a distance x and distance y
	 */
	...
	/**
	 * getter method for obtaining color
	 * @return
	 */
	@Override
	...
	/**
	 * setter method for setting the shape's color
	...
	public Shape deepCopy() {
		return new Ellipse(this.x1, this.y1, this.x2, this.y2, new Color(this.color.getRGB()));
	}

	/**
	 * turn the data of the object into a parseable string, with data separated by delimiters.
	 * @return
	 */
	@Override
	public String toString() {
		return "ellipse:"+color.getRGB()+","+x1+","+y1+","+x2+","+y2+",";
	}
}
