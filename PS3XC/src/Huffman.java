...
public interface Huffman {
     ...
     * @throws IOException
     */
    void compressFile(String pathName, String compressedPathName) throws IOException;
     ...
     * @throws IOException
     */
    void decompressFile(String compressedPathName, String decompressedPathName) throws IOException;
}
